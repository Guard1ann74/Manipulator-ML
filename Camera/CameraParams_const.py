...
## @~chinese 独占权限，其他APP只允许读CCP寄存器                        @~english Exclusive authority, other.txt APP is only allowed to read the CCP register
...
## @~chinese 控制权限，其他APP允许读所有寄存器                         @~english Control authority, allows other.txt APP reading all registers
MV_ACCESS_Control                            = 3
